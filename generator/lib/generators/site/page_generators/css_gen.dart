...
.grammar-container .external-link {
    font-size: 85%;
}
...
.grammar-container .shabda-roopa th,
.grammar-container .kriya-roopa .lakara-roopa th
{
    opacity: 0.5;
    font-size: 70%;
}

.grammar-container .shabda-roopa table tr th:first-child,
.grammar-container .kriya-roopa .lakara-roopa th:first-child
{
    font-size: 100%;
    display: inline-block;
}

.grammar-container .shabda-roopa td:first-child,
.grammar-container .kriya-roopa .lakara-roopa td:first-child
{
    opacity: 0.5;
    font-size: 70%;
}
...
.grammar-point:target .shabda-meta,
.grammar-point:target .kriya-meta,
.grammar-point:target p {
    animation: material-shake 0.5s cubic-bezier(.36,.07,.19,.97) both 3;
}
